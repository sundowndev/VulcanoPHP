...
include_once $this->targetDirs[4].'/vendor/sensio/framework-extra-bundle/Routing/AnnotatedRouteControllerLoader.php';
...
$c = new \Symfony\Component\HttpKernel\Config\FileLocator($a, ($this->targetDirs[4].'/src/Resources'), array(0 => ($this->targetDirs[4].'/src')));
